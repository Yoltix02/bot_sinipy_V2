...
embed1.add_field(name="__sinix/sug__", value=" Pemet de faire une suggestion", inline=False)
embed1.add_field(name="__sinix/invite__", value="Permet d'avoir le lien d'invite de votre discord", inline=False)
embed1.add_field(name="__sinix/blague__", value="Permet de voir ton id", inline=False)
embed1.add_field(name="__sinix/addblague__", value="Permet de voir ton id", inline=False)
embed1.add_field(name="__sinix/level__", value="Permet de voir ton rank", inline=False)
...
embed2.add_field(name="__sinix/clear__", value="Clear un nombre de message", inline=False)
embed2.add_field(name="__sinix/mute__", value="Mute un membre", inline=False)
embed2.add_field(name="__sinix/umute__", value="Umute un membre", inline=False)
embed2.add_field(name="__sinix/ban__", value="Ban un membre", inline=False)
embed2.add_field(name="__sinix/kick__", value="Kick un membre", inline=False)
embed2.add_field(name="__sinix/lock__", value="lock un channel", inline=False)
embed2.add_field(name="__sinix/unlock__", value="unlock un channel", inline=False)
...
embed4.add_field(name="**__Develloper par__**", value="YOLTIX#1647", inline=False)
...
async def play(ctx, url = None, name = None):
    ...
    if not client.is_playing():
        ...
        embed = discord.Embed(title="Musique")
        embed.add_field(name=f"{song.name} A ete ajouter a la liste", value="Faite sinix/skip pour passer a cette musique")
        await ctx.channel.send(embed=embed)
